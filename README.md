...
-   [`Keywords/com/kazurayam/myapp/Foo.groovy`](https://github.com/kazurayam/HowToWriteSLF4JLogsIntoFile/blob/develop/Keywords/com/kazurayam/myapp/Foo.groovy)
...
Now I ran the `Test Cases/TC1`. It runs for a few seconds. It created a log file at `build/logs/myapp.log`, which looks something line this:
...
I could customize the Logback config in Katalon Studio and could write the logs into a text file.
