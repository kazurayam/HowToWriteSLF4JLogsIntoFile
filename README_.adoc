...
You can change the name and location of the Logback config file. See the link:https://github.com/kazurayam/HowToWriteSLF4JLogsIntoFile/blob/develop/Test%40Listeners/ConfigLogger.groovy[Test Listener/ConfigLogger.groovy] file. There you can find the following statement, which you can change as you want:
